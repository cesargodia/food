...
<footer id="colophon" class="site-footer clearfix">
	...
	<div class="content-wrap">
		...
		<div class="site-info">
			...
			<?php echo __(' | Powered by ', 'marketingly') ?> <a href="<?php echo esc_url('https://superbthemes.com/', 'marketingly'); ?>" rel="nofollow noopener"><?php echo __('SuperbThemes!', 'marketingly') ?></a>
			</span>
